...
# Get all xlsm files in Harvest01_2021, loop through and upload/archive
Get-ChildItem "$($Directory)\Harvest01_2021" -Filter *.xlsm |
ForEach-Object {
    # Get file info
    $filePath = $_.FullName
    ...
    # Prepare for upload
    $uri = "https://cafltardatastream.blob.core.windows.net/cafsampleprocessing/Harvest01_2021/$($name)$($sas)"
