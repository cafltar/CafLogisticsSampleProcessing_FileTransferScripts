...
$url = "https://cafltardatastream.blob.core.windows.net/cafplantgridpointsurvey/MasterDets/Harvest01_2021_GP-ART-Lime_INT_YYYYMMDD.xlsm"
$date = Get-Date -Format "yyyyMMdd"
$output = "$($Directory)\Harvest01_2021\Harvest01_2021_GP-ART-Lime_$($Initials.ToUpper())_$($date).xlsm"
